...
function openUserForm(user = null) {
	...
	dialog.innerHTML = `
        <form method="dialog" class="af-form">
            ...
            <div class="af-modal-body">
                <div id="form-error" class="af-error-msg" style="color: var(--danger, red); margin-bottom: 15px; display: none; padding: 10px; background: rgba(255,0,0,0.1); border-radius: 4px;"></div>
                <label>
                    <span>Username</span>
	...
	dialog.querySelector("#form-cancel").onclick = () => {
		dialog.close();
		dialog.remove();
	};
